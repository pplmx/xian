...
<https://github.com/pplmx/wanxiang-engine>(版本 `v0.1.20`)。

```jsonc
// 别人引用它的方式:装发布版压缩包(包里带编译好的 dist,不需要任何构建脚本)
"wanxiang-engine": "https://github.com/pplmx/wanxiang-engine/releases/download/v0.1.20/wanxiang-engine-0.1.20.tgz"
