...
| 命令 | 作用 |
| --- | --- |
| `bun run test` | 全量用例(全量 300 个 spec / 2792 例;本作自己那部分 220 个 / 2198 例) |
...
| 判据 | 钉住的事 |
| --- | --- |
| 用例 | 全量 300 个 spec / 2792 例(本作自己那部分 220 个 / 2198 例),按 9 个系统分类归档 —— 新 spec 没登记分类,`test:report` 会红;例数由 `test:report` 对照本次运行实录核对,加删用例忘了改文档也会红 |
