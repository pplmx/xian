...
## 图标:二十枚水墨笔意,其余仍是 lucide

图标是最后换掉的一层,分两波换,**换的是形与笔,不换语言**:同 24 网格、同线宽(2 起)、
同圆头圆角,故水墨那二十枚能与仍用 lucide 的并肩而不打架。

- **形**改用中式名物:山(洞府)、丹炉(修炼)、双剑(历练)、囊(背包)、打坐的人(人物)、
  灵石、云气(灵气)、墨齿毂(设置);兽爪、枯骨、横头斧、长枪、仙禽、草檐屋舍、锻锤、
  灵苗、摊开的典籍、五出星、雷纹、星芒。原先是火焰、登山包、人像、齿轮、西式尖顶小房子……
- **笔**留一点手写偏差:峰不顶尖、两侧不对称、起收笔略短。

两处是**对着真格子改过两轮**的:斧(刀戈一类)试过大刃短柄、长柄小刃两版,16px 的背包格
里都读成一把钩子,横头那版才立得住;长柄兵器(数据里枪、钩都归这一枚)原先画成「杖头
一颗珠」,16px 下与字母 P 无异,改成斜杆加倒刺才读得出是杆兵器。

**还没换的**:锁定/解锁、分解、关闭、刷新、云、足迹、卷轴那一类功能性图标仍是 lucide
(它们形状约定比意象重要,换意象反而添乱,值得单独一轮只改笔不改形)。数据侧的图标词表
也偏粗(刀与戈都归 axe、枪与钩都归 wand),细分要连着内容一起做。
