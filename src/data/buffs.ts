...
export const BUFFS: BuffDef[] = [
  ...
  // ---- 炼丹自增益三味(概念契约):不是"炼丹专属工具",而是 静心/安神/定心 一族的通用状态丹 ——
  // 服下后心性好转,炼丹面(双成/心得/护料)只是它众多用处里的一格,另配一个通用面(回灵/会心/破境)。
  // id 沿用旧拼音(huohou→安神、cuidan→澄心 是改名前的占位),名称与机制才是真身。
  b('buff_huohou', '安神', 'pill', 900, '神魂安泰,气息绵长 —— 灵气回复提升 25%;凝神观炉,开炉双成概率 +20%', { qiRegen: 0.25, alchemyYield: 0.2 }, 'flame'),
  b('buff_chengxin', '澄心', 'pill', 900, '心念澄澈,出手如神 —— 暴击率提升 8%;炼丹心得泉涌,技艺经验提升 30%', { critRate: 0.08, craftExpGain: 0.3 }, 'sparkles'),
  b('buff_dingxin', '定心', 'pill', 900, '心定则神闲 —— 进阶成功率提升 8%;炼丹手稳,炸炉保料比例提升 50%', { breakthroughRate: 0.08, craftSalvage: 0.5 }, 'shield'),
  // ---- 修速族中段(法则 I2):星驰/御风丹的增益 —— 时长 1800 与聚灵/本源同一炷香口径 ----
  // 目标:单位材料性价比不低于开局聚灵(它 14 草换 15 分)。星驰/御风靠高强度和低草耗,
  // 让玩家在 4/6 境有"换一味更强的前期丹"的理由,而不是补两味没人炼的填充物。
  b('buff_xingchi', '星驰电掣', 'pill', 1800, '照夜星驰,修炼速度提升 60%', { cultivationSpeed: 0.6 }, 'wind'),
  b('buff_yufeng', '御风而行', 'pill', 1800, '长风入体,修炼速度提升 75%', { cultivationSpeed: 0.75 }, 'cloud'),
