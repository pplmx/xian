...
const CATEGORIES = [
  ...
  { name: 'Economy     资源经济', match: ['economySim', 'expIncome', 'lootSim', 'loot.spec', 'salvage', 'smartKeep', 'petLuck', 'pillValue', 'pillService', 'consumableBuffCap', 'veinEconomyAudit', 'veinVisibility', 'resourceGuidance', 'offlineCap', 'offlineLedger', 'offlineParity', 'offlineScope', 'offlineWinnableLoot', 'veinService', 'qiRepair', 'herbExchange'] },
  {
