...
const CATEGORIES = [
  {
    name: 'Engine      公共库内核',
    match: ['packages/engine', 'engineParity', 'engineResourceParity', 'engineHoldingParity', 'engineReforgeParity', 'engineTriageParity', 'engineCombatAblation', 'engineCycleParity']
  },
  {
    name: 'Unit        数值纯函数',
